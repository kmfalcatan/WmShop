...
if (isset($_SESSION['College'])) {
    ...
    $wmsuItemSql = "SELECT * FROM WmsuItem WHERE TypesOfItem = 'Department Polo Shirt'";
    $wmsuItemResult = $conn->query($wmsuItemSql);

    // Retrieve data from CollegeItem table for the logged-in college
    $collegeItemSql = "SELECT * FROM CollegeItem WHERE College = '$college' AND TypesOfItem = 'Department Polo Shirt'";
