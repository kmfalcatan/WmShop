<?php include('../function/users.php') ?>
        ...
        <div class='container'>
            <div class='filterContainer1'>
                <div class='subFilterContainer1'>
                    <a href='../adminPanel/CollegeUser.php' class='filter1'><button class='filter1' onclick='changeColor(this)'>College</button></a>
                </div>
            </div>
